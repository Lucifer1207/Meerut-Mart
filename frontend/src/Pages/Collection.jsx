...
const Collection = () => {
  ...
  const [curr,setCurr]=useState('chair');
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 ${showFilter? '':'hidden'} sm:block`}>
          ...
          <div className='flex flex-col gap-2 text-sm font-light text-gray-700'>
            ...
            }
            {
              curr === 'men' || curr === 'women' || curr === 'kids' ? 
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={'Topwear'} onChange={toggleSubCategory} /> Bottom wear
            </p> : ''
            }
            {
              curr === 'men' || curr === 'women' || curr === 'kids' ? 
            <p className='flex gap-2'>
              <input type="checkbox" className='w-3' value={'Topwear'} onChange={toggleSubCategory} /> Winterwear
            </p> : ''
            }
